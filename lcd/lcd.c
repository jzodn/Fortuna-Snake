...
void display_char(char c)
{
    ...
    //Starts a new line if the char is a newline control character 
    if (c == 10) {
        display.x=0;
        display.y+=8;

        //Clears the screen if a newline control character is used at the end of the display
        if (display.y >= 240) clear_screen();
        }
